...
subtitle: "Release Candidate 1.0.0"
...
| Version | 1.0.0 |
| Status | Release candidate; authority not effective before G9 |
| Date | 2026-09-05 |
| Authority | Grand Challenge Labs |
| Language | Canadian English |
| Historical predecessor | GCL-TCS-00/0.1.0 at commit `8833253f620c6c05930740bda983d6f43bee6612` |
| Supersession | Proposed only; predecessor is superseded only after exact-revision G8 PASS and G9 atomic admission |
...
This release-candidate document does not acquire authority through publication or repository merge. Version-1 authority becomes effective only through the promotion sequence defined by this charter.
