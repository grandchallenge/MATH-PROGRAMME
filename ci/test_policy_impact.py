...
def main()->int:
    ...
    runner_control=impact.classify_paths(['ci/run_unittest_modules.py']);assert runner_control['policy_shards']==['core','contracts'];assert not runner_control['unknown_paths'];assert not any(runner_control['formal_dirty'].values())
