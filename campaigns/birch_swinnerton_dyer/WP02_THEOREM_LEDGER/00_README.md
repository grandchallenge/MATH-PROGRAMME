...
- theorem text audited and composable;
- abstract or bibliographic scope audited but not composable without reopening the source;
- formal consequences derived from exact sequences or functional equations;
- family and computational results that remain below the universal quantifier.
