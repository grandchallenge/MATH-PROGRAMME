...
| HC-WP00 | work package | MATH-PROGRAMME | `campaigns/hodge_conjecture/WP00_FOUNDATION_STATUS/00_README.md` | draft | `ADR-0004` | `docs/AGENT_COUNCIL_TERMINOLOGY_REGISTRY.md` | `reviews/hodge_conjecture/HC-WP00.agent_review.yaml` | 2026-07-24 | pending |
