...
| BSD-WP03 | work package | MATH-PROGRAMME | `campaigns/birch_swinnerton_dyer/WP03_COMPUTATIONAL_FORMAL_SUBSTRATE/00_README.md` | review_ready | `ADR-0005` | `docs/AGENT_COUNCIL_TERMINOLOGY_REGISTRY.md` | `reviews/birch_swinnerton_dyer/BSD-WP03.agent_review.yaml` | 2026-07-24 | pending |
