...
| BSD-WP01 | work package | MATHFORGE | `campaigns/birch_swinnerton_dyer/WP01_FALSE_PROOF_ATLAS/00_README.md` | review_ready | `ADR-0005` | `docs/AGENT_COUNCIL_TERMINOLOGY_REGISTRY.md` | `reviews/birch_swinnerton_dyer/BSD-WP01.agent_review.yaml` | 2026-07-24 | pending |
| BSD-WP02 | work package | MATHSOLVE | `campaigns/birch_swinnerton_dyer/WP02_THEOREM_LEDGER/00_README.md` | review_ready | `ADR-0005` | `docs/AGENT_COUNCIL_TERMINOLOGY_REGISTRY.md` | `reviews/birch_swinnerton_dyer/BSD-WP02.agent_review.yaml` | 2026-07-24 | pending |
