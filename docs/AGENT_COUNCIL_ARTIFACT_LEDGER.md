...
| NS-CI-WP02 | work package | MATHSOLVE | `campaigns/navier_stokes_critical_integrability/WP02_CONDITIONAL_REGULARITY_LEDGER/00_README.md` | referee_promoted | `reviews/navier_stokes/NS-CI-WP02.agent_review.yaml` | reviewed |

## Integration order

Merge WP01 governance before WP02. The WP02 branch carries the combined ledger state.
