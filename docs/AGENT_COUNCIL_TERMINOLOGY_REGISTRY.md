...
The decision-record storage, schema-bound review, lifecycle-status, and disposition terms were normalized by `ADR-0007`. Programme-domain, public-coverage, execution-layer, and public-status terms are governed by `ADR-0008`. Governed-campaign discovery and the promotion-register boundary are governed by `ADR-0009`. Documentary authority, release availability, web-edition contracts, and retained RH post-merge blockers are governed by `ADR-0010`.
