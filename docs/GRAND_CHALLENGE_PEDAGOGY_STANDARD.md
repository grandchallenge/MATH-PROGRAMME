...
<p class="page-deck">Grand Challenge pedagogy is structural revelation under claim control. It exists to help a serious reader see the object, the obstruction, the support route, the proof boundary, and the next executable move.</p>
