...
|---|---|---|---|---|---:|---|---|
| [The Shape of a Sphere](poincare.md) | Reference | `PC` / `PC-001` | Poincaré theorem reconstruction | Solved classical theorem | 33 pages | [Record](sources/the_shape_of_a_sphere.tex) | [Edition](poincare.edition.json) |
...
The candidate registry currently records *The Element in Half the Worlds*, a full-tier Union-Closed documentary source lock. Frankl's conjecture remains open. The candidate has no public browser page, edition record, asset directory, admitted source record, or manifest membership. UC-DOC-WP01 may continue construction, but public admission remains atomic and separately reviewed.
...
Git stores admitted web records, admitted source-record pointers, edition records, candidate metadata, schemas, and validation contracts. Candidate source pointers remain under their governing campaign until admission.
