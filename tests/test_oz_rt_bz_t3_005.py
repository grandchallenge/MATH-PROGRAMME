...
def reject(r=None,s=None,j=None): assert v.errors(R if r is None else r,S if s is None else s,J if j is None else j,run_independent=False)
def main():
 assert v.errors(R,S,J,run_independent=False)==[]
 ...
 print('OZ-RT-BZ-T3-005 adversarial mutation firewall valid'); return 0
